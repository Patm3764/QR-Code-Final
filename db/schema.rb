...
ActiveRecord::Schema.define(version: 20141205203718) do
  ...
  add_index "locations_participants", ["locations_id"], name: "index_locations_participants_on_locations_id"
  add_index "locations_participants", ["participants_id"], name: "index_locations_participants_on_participants_id"
